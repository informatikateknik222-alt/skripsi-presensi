...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Karena Auth Service dihilangkan, kita gunakan dummy login
      ...
      const dummyUser = {
        ...
        role: username.toLowerCase().includes("sdm") ? "SDM" : 
              username.toLowerCase().includes("keu") ? "KEUANGAN" : "EMPLOYEE",
        name: username || "Administrator"
      };

      // Simpan token dummy dan info user
